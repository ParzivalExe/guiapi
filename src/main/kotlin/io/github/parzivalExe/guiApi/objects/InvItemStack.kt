...
class InvItemStack(var itemStack: ItemStack, var invPosition: Int) {
    ...
    constructor(type: Int, amount: Int, damage: Short, data: Byte, invPosition: Int)
            : this(ItemStack(Material.getMaterial(type.toString())!!, amount, damage, data), invPosition)

    constructor(type: Int, invPosition: Int)
            : this(type, 1, invPosition)

    constructor(type: Int, amount: Int, invPosition: Int)
            : this(ItemStack(Material.getMaterial(type.toString())!!, amount, 0, 0), invPosition)
